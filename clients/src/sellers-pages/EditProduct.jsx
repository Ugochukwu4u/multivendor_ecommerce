        ...
        <div className='add-product'>
            <div className='product-navigation'>
                <ul>
                    ...
                    <li className='add-link'>Edit Product</li>
                </ul>
            </div>
            ...
            <div className="add-product-wrapper">
               ...
               <div className="add-left-basic-info">
                ...
                <div className="add-product-sec">
                    ...
                    <textarea name="specification" id="" value={formData.specification.join(',')} onChange={handleArrayChange}></textarea>
                </div>
                <div className="add-product-sec">
                ...
                <button><i class='bx bx-upload' ></i>Save</button>
                </div>
                </form>
            </div>
        </div>
